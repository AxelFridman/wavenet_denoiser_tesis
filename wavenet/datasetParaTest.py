...
class AudioCleaningDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        possible_start = 0#random.randint(0, max(0,(noise_waveform[0].shape[0] - noise_waveform.shape[0])))
        noise_waveform = noise_waveform[:,possible_start:possible_start+waveform_dirty[0].shape[0]]

        current_snr = random.uniform(self.snr * self.min_snr_coef, self.snr)
        #print()
        #print("wave")
        #print(waveform_dirty.shape)
        #print("ruido")
